...
<head>
    ...
    <style>
        :root {
            --bg-dark: #090e1a;
            --surface: #111827;
            --primary: #4e73df; /* FIXED: Blue instead of Green */
            --accent: #3b82f6;
                                ...
                                <tr class="student-row">
                                    <td>
                                        <div class="d-flex align-items-center gap-3">
                                            ...
                                            <div>
                                                <div class="fw-bold text-white">${enroll.student.fullName}</div>
                                                <div class="small text-dim">${enroll.student.email}</div>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="fw-bold text-white" style="font-size: 0.85rem;">${enroll.course.title}</div>
                                    ...
                                    <td>
                                        <div class="small fw-bold text-dim">${enroll.enrolledAt}</div>
                                    </td>
                                </tr>
                            </c:forEach>
                        </tbody>
