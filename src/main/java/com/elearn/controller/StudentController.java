...
public class StudentController {
    ...
    public String dashboard(
        ...
        long completedCount = enrollments.stream()
                .filter(Enrollment::isCompleted).count();
        ...
        model.addAttribute("certificates",
            certificateService.getCertificatesByUser(student));
        model.addAttribute("quizResults",
            quizService.getStudentResults(student));
    ...
    public String processPayment(
        ...
        try {
            ...
            redirectAttrs.addFlashAttribute("successMsg",
                "Payment successful! Course mein enrolled ho gaye.");
    ...
    public String learnPage(
        ...
        Enrollment enrollment = enrollmentService
            .getEnrollment(student, course);

        List<CourseModule> modules = course.getModules();

        // Default: pehla lesson load karo
        ...
        if (currentLesson == null && !modules.isEmpty()
                && !modules.get(0).getLessons().isEmpty()) {
            currentLesson = modules.get(0).getLessons().get(0);
        }

        List<Progress> progressList =
            progressService.getProgressForEnrollment(enrollment);
    ...
    public String submitQuiz(
            @ModelAttribute QuizSubmitDto dto,
            @AuthenticationPrincipal UserDetails ud,
            RedirectAttributes redirectAttrs) {
        ...
        try {
            QuizResult result =
                quizService.submitQuiz(student, dto);
            redirectAttrs.addFlashAttribute("quizResult", result);
            redirectAttrs.addFlashAttribute("successMsg",
    ...
    public String submitAssignment(
        ...
        try {
            assignmentService.submitAssignment(
                student, assignmentId, submissionText);
            redirectAttrs.addFlashAttribute("successMsg",
    ...
    public String verifyCertificate(
        ...
        certificateService.verifyCertificate(certNumber)
            .ifPresentOrElse(
                cert -> {
 ...
 // Profile Page
    ...
    public String profilePage(
        ...
        model.addAttribute("totalEnrolled",
            enrollmentService
                .getStudentEnrollments(student).size());
        ...
        model.addAttribute("certificates",
            certificateService
                .getCertificatesByUser(student));
        return "student/profile";
    }

 // Update Profile — UserService signature match karo
    ...
    public String updateProfile(
        ...
        try {
            ...
            // ✅ UserService ka actual signature use karo
            userService.updateProfile(
                student.getId(),  // Long id
                fullName,         // String fullName
                phone,            // String phone
                bio,              // String bio
                null              // String profilePicture
            );
    ...
    // Change Password — UserService signature match karo
    ...
    public String changePassword(
        ...
        try {
            if (!newPassword.equals(confirmPassword)) {
                ra.addFlashAttribute("errorMsg",
                    "New passwords match nahi kar rahe!");
                return "redirect:/student/profile";
            }
